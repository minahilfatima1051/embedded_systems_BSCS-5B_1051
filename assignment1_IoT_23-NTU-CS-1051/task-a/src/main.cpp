// Assignment-1 Task-a
// Use one button to cycle through LED modes and use second button to reset to OFF.
// Embedded IoT Systems Fall-2025

// Name: Minahil Fatima                          // Reg#: 23-NTU-CS-1051
...
// Defining the pins used for connecting components
#define LED1 14
#define LED2 16
#define LED3 17
